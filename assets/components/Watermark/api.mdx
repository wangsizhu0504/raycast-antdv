...
| progress | 自定义进度条样式 | [ProgressProps](https://www.antdv.com/components/progress/#api)（仅支持 `type="line"`） | { strokeWidth: 2, showInfo: false } | 3.0 |  |
