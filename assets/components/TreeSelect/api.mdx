...
attr: props
order: 0
url: components/tree-select-cn#api
---
...
| treeLine | 是否展示线条样式，请参考 [Tree - showLine](https://www.antdv.com/components/tree/#components-tree-demo-line) | boolean \| object | false | 3.0 |  |
